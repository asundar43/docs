...
SimpleClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.simpleclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["simpleclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
