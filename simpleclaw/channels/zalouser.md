...
read_when:
  - Setting up Zalo Personal for SimpleClaw
...
- Install via CLI: `simpleclaw plugins install @simpleclaw/zalouser`
- Or from a source checkout: `simpleclaw plugins install ./extensions/zalouser`
...
2. Login (QR, on the Gateway machine):
   - `simpleclaw channels login --channel zalouser`
...
- `simpleclaw pairing list zalouser`
- `simpleclaw pairing approve zalouser <code>`
...
- On startup, SimpleClaw resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `simpleclaw channels logout --channel zalouser && simpleclaw channels login --channel zalouser`
