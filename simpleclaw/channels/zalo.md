...
- Install via CLI: `simpleclaw plugins install @simpleclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `simpleclaw plugins install ./extensions/zalo`
   - From npm (if published): `simpleclaw plugins install @simpleclaw/zalo`
...
- Approve via:
  - `simpleclaw pairing list zalo`
  - `simpleclaw pairing approve zalo <CODE>`
...
- Example: `simpleclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `simpleclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `simpleclaw logs --follow`
