...
read_when:
  - You want SimpleClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables SimpleClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`simpleclaw onboard`) and `simpleclaw channels add` list optional channel plugins.
...
```bash
simpleclaw plugins install @simpleclaw/nostr
```

Use a local checkout (dev workflows):

```bash
simpleclaw plugins install --link <path-to-simpleclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "simpleclaw",
        "displayName": "SimpleClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "simpleclaw@example.com",
        "lud16": "simpleclaw@example.com"
      }
    }
  }
}
