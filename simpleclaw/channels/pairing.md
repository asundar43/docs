...
read_when:
  ...
  - Reviewing SimpleClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is SimpleClaw’s explicit **owner approval** step.
...
Stored under `~/.simpleclaw/credentials/`:
...
3. On your phone, open the SimpleClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `simpleclaw nodes pending/approve`) is a
