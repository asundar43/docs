...
SimpleClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SimpleClaw also aligns
the install method:
...
When you switch channels with `simpleclaw update`, SimpleClaw also syncs plugin sources:
