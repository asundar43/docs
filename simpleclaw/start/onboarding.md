---
summary: "First-run onboarding flow for SimpleClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SimpleClaw">
...
<Step title="CLI">
  ...
  The app can install the global `simpleclaw` CLI via npm/pnpm so terminal
