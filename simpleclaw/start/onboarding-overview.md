---
summary: "Overview of SimpleClaw onboarding options and flows"
read_when:
...
SimpleClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`simpleclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the SimpleClaw app when you want a fully guided setup on macOS. Docs:
