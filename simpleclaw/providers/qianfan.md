---
summary: "Use Qianfan's unified API to access many models in SimpleClaw"
read_when:
...
3. SimpleClaw installed on your system
...
4. Copy the API key for use with SimpleClaw

## CLI setup

```bash
simpleclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SimpleClaw Configuration](/gateway/configuration)
