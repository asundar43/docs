...
Deepgram is a speech-to-text API. In SimpleClaw it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, SimpleClaw uploads the audio file to Deepgram and injects the transcript
