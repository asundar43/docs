---
summary: "Use NVIDIA's OpenAI-compatible API in SimpleClaw"
read_when:
  - You want to use NVIDIA models in SimpleClaw
...
simpleclaw onboard --auth-choice skip
simpleclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
