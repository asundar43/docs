...
read_when:
  - You are building a SimpleClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (simpleclaw.plugin.json)

Every plugin **must** ship a `simpleclaw.plugin.json` file in the **plugin root**.
SimpleClaw uses this manifest to validate configuration **without executing plugin
