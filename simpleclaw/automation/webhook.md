...
read_when:
  ...
  - Wiring external systems into SimpleClaw
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your SimpleClaw config directory (typically `~/.simpleclaw/hooks/transforms`).
...
- `simpleclaw webhooks gmail setup` writes `hooks.gmail` config for `simpleclaw webhooks gmail run`.
