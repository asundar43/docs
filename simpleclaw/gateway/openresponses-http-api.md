...
SimpleClaw’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`simpleclaw agent`), so routing/permissions/config match your Gateway.
